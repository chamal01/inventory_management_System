...
<button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#modalrequestproduct">
    Request New Product
</button>

<!-- Modal -->
<div class="modal fade" id="modalrequestproduct" tabindex="-1" aria-labelledby="modalrequestproduct" aria-hidden="true">
    <div class="modal-dialog modal-lg"> <!-- Adjust the modal size as needed -->
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalrequestproduct">Request a New Product</h5>
